...
def train_prediction_model():
    ...
    X['Hour'] = pd.to_numeric(X['Hour'])  # Convert Hour to numeric if necessary
...
def plot_predicted_and_nearby_clusters(lat, lon, hour, num_nearby_clusters=3):
    ...
    n_clusters = min(70, num_samples)  # Use 100 clusters or less if fewer samples are available
